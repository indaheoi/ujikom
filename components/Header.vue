      ...
      <div class="header relative">
            ...
            <div class="sosmed flex gap-3 ms-[500px] relative bottom-3">
                ...
                <button class="ig btn sm:md:lg: btn-circle">
                  <a target="_blank" rel="noreferrer noopener" href="https://www.instagram.com/smkn4tsmofficial?igsh=MWV3aTU4aTRlbGx3eg==">
                ...
                <button class="yt btn sm:md:lg: btn-circle">
                  <a target="_blank" rel="noreferrer noopener" href="https://youtube.com/@smkn4tasikmalayamediaoffic704?si=HHCXd4mQqb37OiOr">
                ...
                <button class="tt btn sm:md:lg: btn-circle">
                  <a target="_blank" rel="noreferrer noopener" href="https://www.tiktok.com/@smkn4tasikmalaya?_t=8sbpR1Y46vC&_r=1">
                    <svg class="w-[30px] h-[30px] fill-[#8e8e8e]" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <button class="li btn sm:md:lg: btn-circle">
                  <a target="_blank" rel="noreferrer noopener" href="https://www.linkedin.com/company/smkn-4-tasikmalaya/">
                    <svg class="w-[30px] h-[30px] fill-[#8e8e8e]" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
