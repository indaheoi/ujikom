  ...
  <div class="bg-blue-500 bg-opacity-50">
    <div class="max-w-full mx-4 py-6 sm:mx-auto sm:px-6 lg:px-8">
      <div class="sm:flex sm:space-x-4">
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow hover:scale-105 transform transition-all duration-500 mb-4 w-full sm:w-1/3 sm:my-8">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow hover:scale-105 transform transition-all duration-500 mb-4 w-full sm:w-1/3 sm:my-8">
          <div class="bg-white p-5">
            <div class="sm:flex sm:items-start">
              <div class="text-center sm:mt-0 sm:ml-2 sm:text-left">
                <svg fill="#5e5555" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 508.1 508.1" xml:space="preserve" stroke="#5e5555">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
                    <g>
                      <g>
                        <path
                          d="M396.7,237.2c-25.3-10.1-51.8-17.6-78.8-22.1c-6.5-1.1-12.9,2.5-15.4,8.6l-48.4,118.7l-48.4-118.7 c-2.5-6.1-8.9-9.7-15.4-8.6c-27,4.6-53.5,12-78.8,22.1c-23.6,9.4-38.8,31.9-38.8,57.2V494c0,7.8,6.3,14.1,14.1,14.1h334.5 c7.8,0,14.1-6.3,14.1-14.1V294.3C435.5,269,420.2,246.6,396.7,237.2z M407.3,479.8H100.9V294.3c0-13.7,8.3-25.8,21.1-31 c19.9-8,40.7-14.2,61.9-18.4L241,385.1c2.2,5.3,7.3,8.8,13.1,8.8c5.7,0,10.9-3.5,13.1-8.8l57.1-140.2c21.2,4.3,42,10.5,61.9,18.4 c12.8,5.1,21.1,17.3,21.1,31V479.8z"
                        ></path>
                      </g>
                    </g>
                    <g>
                      <g><path d="M254.1,0c-52.3,0-94.8,42.5-94.8,94.8s42.5,94.8,94.8,94.8s94.8-42.5,94.8-94.8S306.4,0,254.1,0z M254.1,161.4 c-36.7,0-66.6-29.9-66.6-66.6s29.9-66.6,66.6-66.6s66.6,29.9,66.6,66.6S290.8,161.4,254.1,161.4z"></path></g>
                    </g>
                  </g>
                </svg>
                <h3 class="text-sm leading-6 font-medium text-gray-400">Laki-laki</h3>
                <p class="text-3xl font-bold text-black">82 Orang</p>
              </div>
            </div>
          </div>
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow hover:scale-105 transform transition-all duration-500 mb-4 w-full sm:w-1/3 sm:my-8">
          <div class="bg-white p-5">
            <div class="sm:flex sm:items-start">
              <div class="text-center sm:mt-0 sm:ml-2 sm:text-left">
                <svg fill="#5e5555" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 508 508" xml:space="preserve" stroke="#5e5555">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
                    <g>
                    ...
                    <g>
                      <g>
                        <path
                          d="M339.05,100.4c-2.6-3.8-7.5-6.1-12.1-6.1c-19.8,0-38.7-4.6-56.1-13.7c-6-3.1-13.4-1.6-17.6,3.7 c-23.1,29-50,39.7-83.5,33.3c-6.8-1.3-13.5,2.5-15.9,9c-5.2,13.9-7.8,28.5-7.8,43.4c0,64.2,48.1,116.4,107.2,116.4 c59.1,0,107.2-52.2,107.2-116.4C360.45,144.7,353.05,120.7,339.05,100.4z M253.25,258.1c-43.5,0-79-39.6-79-88.2 c0-7.7,0.9-15.4,2.7-22.8c35.3,3.3,65.7-9.1,91-36.7c16.4,7.1,33.7,11,51.6,11.9c8.3,14.2,12.6,30.5,12.6,47.6 C332.15,218.6,296.75,258.1,253.25,258.1z"
                        ></path>
                      </g>
                    </g>
                    <g>
                      <g>
                        <path
                          d="M323.95,316.3c-6.3-2-13.1,0.6-16.4,6.3l-53.7,91.4l-53.6-91.4c-3.3-5.7-10.2-8.3-16.4-6.3 c-84,26.5-140.4,97.9-140.4,177.6c0,7.8,6.3,14.1,14.1,14.1h392.8c0.1,0,0.1,0,0.1,0c7.8,0,14.1-6.3,14.1-14.1 C464.55,414.1,407.25,342.5,323.95,316.3z M72.35,479.8c5.9-58.3,48-109.6,109.4-132.9l59.9,102.1c2.5,4.3,7.2,7,12.2,7 s9.6-2.6,12.2-7l60-102.1c61.4,23.3,103.5,74.6,109.4,132.9H72.35z"
                        ></path>
                      </g>
                    </g>
                    <g>
                      <g><circle cx="215.35" cy="174.2" r="14.1"></circle></g>
                    </g>
                    <g>
                      <g><circle cx="291.05" cy="174.2" r="14.1"></circle></g>
                    </g>
                  </g>
                </svg>
                <h3 class="text-sm leading-6 font-medium text-gray-400">Perempuan</h3>
    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
      <div class="text-center pb-12">
        <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-gray-900">Check our awesome team members</h1>
      </div>
      <!-- guru 1 -->
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
          <div class="hover:scale-105 transform transition-all duration-500">
            <img class="object-center object-cover h-[300px] w-[400px]" src="/assets/css/img/guru/guru.jpg" alt="photo" />
          </div>
